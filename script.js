  ...
  memories: {
    ...
    cards   : [
      ...
      },
      {
        ...
        title   : 'CARD 07 — THE LITTLE THINGS',
        date    : '',
        message : 'The tiny gestures, the silly jokes, the mornings we share — they are the moments I want to replay forever. ♡',
      },
      {
        image   : 'assets/memory-8.jpg',
        title   : 'CARD 08 — EVERY SEASON',
        date    : '',
        message : 'Every season of us is my favorite — even the storms, because we weathered them together.',
      },
      {
        image   : 'assets/memory-9.jpg',
        title   : 'CARD 09 — YOUR EYES',
        date    : '',
        message : 'I could get lost in your eyes and never ask for directions. ♡',
      },
      {
        image   : 'assets/memory-10.jpg',
        title   : 'CARD 10 — HAND IN HAND',
        date    : '',
        message : 'Your hand in mine turns every ordinary road into an adventure.',
      },
      {
        image   : 'assets/memory-11.jpg',
        title   : 'CARD 11 — STILL CRAZY ABOUT YOU',
        date    : '',
        message : 'Months later, I still catch myself smiling over you like it is day one.',
      },
      {
        image   : 'assets/memory-12.jpg',
        title   : 'CARD 12 — THE QUIET',
        date    : '',
        message : 'Even in our quietest moments, nothing ever feels silent when you are beside me.',
      },
      {
        image   : 'assets/memory-13.jpg',
        title   : 'CARD 13 — MAKING MEMORIES',
        date    : '',
        message : 'We are not just making memories — we are building something unbreakable.',
      },
      {
        image   : 'assets/memory-14.jpg',
        title   : 'CARD 14 — GROWING TOGETHER',
        date    : '',
        message : 'Every version of you is beautiful, and I am proud to grow beside every single one.',
      },
      {
        image   : 'assets/memory-15.jpg',
        title   : 'CARD 15 — FOREVER BEGINS NOW',
        date    : 'today, tomorrow, always',
        message : 'Today is your birthday, but the real celebration is that we get to celebrate all the years together. ♡',
      },
    ],
  },
